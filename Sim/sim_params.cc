...
sim_params::sim_params(const char *fn):
    ...
    while(!feof(f)){
        ...
        if(se(bp, "suppress")){
            ...
            hit_kf2 = final_int(ln);
        } else if(se(bp, "hit_target_energy")){
            hit_target_energy = final_double(ln);
        } else if(se(bp, "hit_target_urms")){
            hit_target_urms = final_double(ln);
        } else if(se(bp, "hit_init_spectrum_type")){
